...
import com.gentlecorp.person.models.events.CreateAccountDTO;
import com.gentlecorp.person.models.events.DeleteAccountDTO;
import com.gentlecorp.person.models.events.LogDTO;
import com.gentlecorp.person.models.events.SendMailEvent;
import com.gentlecorp.person.models.events.ShoppingCartDTO;
import com.gentlecorp.person.models.entities.Person;
import com.gentlecorp.person.tracing.TraceContextUtil;
...
import static com.gentlecorp.person.messaging.KafkaTopicProperties.*;
...
public class KafkaPublisherService {
    ...
    public void createAccount(UUID personId, String username) {
        ...
        sendKafkaEvent(TOPIC_ACCOUNT_CREATED, accountDTO, "createAccount");
    }
    ...
    public void deleteAccount(UUID personId, int version, String username) {
        ...
        sendKafkaEvent(TOPIC_ACCOUNT_DELETE, deleteAccountDTO, "deleteAccount");
    }
    ...
    public void createShoppingCart(UUID personId, String username) {
        ...
        sendKafkaEvent(TOPIC_SHOPPING_CART_CREATED, shoppingCartDTO, "createShoppingCart");
    }

    @Observed(name = "kafka-publisher.shopping-cart")
    public void deleteShoppingCart(UUID personId) {
        sendKafkaEvent(TOPIC_SHOPPING_CART_DELETED, personId.toString(), "deleteShoppingCart");
    }
